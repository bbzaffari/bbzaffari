...
- **Focus Areas:** C/C++ systems, embedded, AI systems, dependable design, automation, hardware–software co-design, vector-based retrieval (FAISS), hybrid packaging (C++/Python),
